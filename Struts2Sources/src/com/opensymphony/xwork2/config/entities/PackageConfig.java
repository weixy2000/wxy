 ...
 * Package配置信息.
 * <p/>
 * 在struts的xml配置文件中以<code>package</code>标签定义的内容
 *
...
public class PackageConfig extends Located implements Comparable, Serializable, InterceptorLocator {
    ...
    /**
     * 获取所有位于该package内的ResultConfigs
     *
     * @return 返回一个以result名称为key,ResultConfig为value的Map
     * @see ResultConfig
     */
    ...
    public static class Builder implements InterceptorLocator {
        ...
        /**
         * 为这个package包定义默认的defaultResultType
         *
