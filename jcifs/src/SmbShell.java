...
/**
 *　使用Samba模拟实现Shell命令，包括:ls,cd,pwd,quit
 */
public class SmbShell extends NtlmAuthenticator {
                ...
                if( cmd.equals( "" ) ) {
                    ...
                    if( list != null ) {
                        for( int j = 0; j < list.length; j++ ) {
                            ...
                            System.out.print(String.format("%-40s", list[j].getName()));
                            ...
                            System.out.print(String.format("%-6s", sb.toString()));
                            System.out.print(String.format("%10s", list[j].getName()));
                            

                            System.out.print( sdf1.format( date ));
                            //Format.print( System.out, "%3s ", sdf2.format( date ));
                            System.out.print(String.format("%3s", sdf2.format(date)));
    ...
    public static void main( String[] argv ) throws Exception {
    	//argv = new String[]{"smb://Administrator:123abc@192.168.1.168/pp/"};
