...
public class RetrievalUtils {
    ...
    /**
     * 从所有上下文(page, request, session, application)中检索key对应的value
    ...
    /**
     * 从指定上下文(page或request或session或application)中检索key对应的value<br/>
    ...
    /**
     * 从所有上下文(page, request, session, application)中检索一个集合
    ...
    /**
     * 
     * 从指定上下文(page或request或session或application)中检索一个集合<br/>
     * 
