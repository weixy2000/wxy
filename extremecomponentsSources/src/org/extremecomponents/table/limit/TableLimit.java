...
public final class TableLimit implements Limit {
    ...
    /**
     * 当使用Limit时必须调用这个方法设置以下属性值： rowStart, rowEnd, currentRowsDisplayed and page
     * 
     * @param totalRows table的总记录数
     * @param rowsDisplayed table默认一页显示行数. table中定义或Preferences中定义
     */
