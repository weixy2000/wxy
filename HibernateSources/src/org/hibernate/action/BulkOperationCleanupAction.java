...
public class BulkOperationCleanupAction implements Executable, Serializable {
	private final Serializable[] affectedTableSpaces;//受影响的表空间

	private final Set entityCleanups = new HashSet();//Entity清理
	private final Set collectionCleanups = new HashSet();//集合清理
